...
c1_Kjell = Get_dispersion(U1, z, kv1[::some], Yps=Yps) / c0
print('1')
c2_Kjell = Get_dispersion(U2, z, kv2[::some],Yps=Yps) / c0
print('2')
c3_Kjell = Get_dispersion(U3, z, kv3[::some], Yps=Yps) / c0
print('3')
...
ax[0, 1].plot(kv1, c1_Kjell * kv1 / w01, ':', c='tomato', lw=1.5, label='Magnus 1st')
ax[0, 2].loglog(kv1, np.abs((c_KC1-c_DIM1)/c_DIM1), ls='--', c='royalblue', lw=1, label=r'K\&C$_\textrm{1st}$')
ax[0, 2].loglog(kv1, np.abs((c1_Kjell-c_DIM1)/c_DIM1), c='tomato', lw=1, label='Magnus 1st')
...
ax[1, 1].plot(kv2, c2_Kjell * kv2 / w02, ':', c='tomato', lw=1.5, label='Magnus 1st')
ax[1, 2].loglog(kv2, np.abs((c_KC2-c_DIM2)/c_DIM2), ls='--', c='royalblue', lw=1, label=r'K\&C$_\textrm{1st}$')
ax[1, 2].loglog(kv2, np.abs((c2_Kjell-c_DIM2)/c_DIM2), c='tomato', lw=1, label='Magnus 1st')
...
ax[2, 1].semilogx(kv3, c3_Kjell * kv3 / w03, ':', c='tomato', lw=1.5, label='Magnus 1st')
ax[2, 2].loglog(kv3, np.abs((c_KC3-c_DIM3)/c_DIM3), ls='--', c='royalblue', lw=1, label=r'K\&C$_\textrm{1st}$')
ax[2, 2].loglog(kv3, np.abs((c3_Kjell-c_DIM3)/c_DIM3), c='tomato', lw=1, label='Magnus 1st')
